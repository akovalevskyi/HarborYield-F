    ...
    <Shell>
      ...
      <section className="hero compact">
        <div className="hero-top">
          <h1>P2P market listings across chains.</h1>
            ...
            {filteredListings.map((listing) => {
              ...
              return (
                <Link
                  ...
                  className="card"
                  href={`/p2pmarket/asset/${listing.chainId}/${listing.tokenId}?listingId=${listing.id}`}
                >
                  <div className={`card-media ${image ? "has-image" : "no-image"}`}>
                    <div className="card-media-bg" style={getCardBackground(image)} />
