...
const He = "[object RegExp]", te = "[object String]", se = "[object Number]", ie = "[object Boolean]", ne = "[object Arguments]", Ue = "[object Symbol]", Be = "[object Date]", Le = "[object Map]", Me = "[object Set]", ze = "[object Array]", Ge = "[object ArrayBuffer]", We = "[object Object]", Je = "[object DataView]", Ke = "[object Uint8Array]", Ve = "[object Uint8ClampedArray]", Ye = "[object Uint16Array]", Xe = "[object Uint32Array]", ke = "[object Int8Array]", Qe = "[object Int16Array]", Ze = "[object Int32Array]", Te = "[object Float32Array]", et = "[object Float64Array]";
function F(t) {
...
function $(t, e, s, i) {
    ...
    for(let a = 0; a < r.length; a++){
        ...
        if (ae(c) && (c = {
            ...
            ...o
        }), typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"] < "u" && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].isBuffer(c) && (c = re(c)), Array.isArray(c)) if (typeof o == "object" && o != null) {
        ...
        p != null ? t[n] = p : Array.isArray(c) || ce(o) && ce(c) ? t[n] = $(o, c, s, i) : o == null && at(c) ? t[n] = $({}, c, s, i) : o == null && rt(c) ? t[n] = re(c) : (o === void 0 || c !== void 0) && (t[n] = c);
    }
    return t;
}
function ht(t, ...e) {
...
const oe = "error", pt = "wss://relay.walletconnect.org", lt = "wc", he = "universal_provider", A = `${lt}@2:${he}:`, pe = "https://rpc.walletconnect.org/v1/", le = "generic", ut = `${pe}bundler`, v = "call_status", dt = 86400, H = {
...
function we(t) {
    ...
    for (const [s, i] of Object.entries(t)){
        const r = i.methods || [], a = i.events || [], n = i.accounts || [], c = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCaipNamespace"])(s) ? [
            s
        ] : i.chains ? i.chains : me(i.accounts);
        e[s] = {
            chains: c,
            methods: r,
            events: a,
...
async function Lt(t, e) {
    const s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseChainId"])(t.result.capabilities.caip345.caip2), i = t.result.capabilities.caip345.transactionHashes, r = await Promise.allSettled(i.map((h)=>Mt(s.reference, h, e))), a = r.filter((h)=>h.status === "fulfilled").map((h)=>h.value).filter((h)=>h);
...
async function zt({ sendCalls: t, storage: e }) {
    ...
    await e.setItem(v, Bt(Ut({}, s), {
        [t.result.id]: {
            request: t.request,
            result: t.result,
            expiry: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calcExpiry"])(dt)
        }
    }));
}
...
class kt {
    ...
    createHttpProvider(e, s) {
        const i = s || fe(`${this.name}:${e}`, this.namespace, this.client.core.projectId);
    ...
    getHttpProvider(e) {
        ...
        return this.httpProviders[s] || (this.httpProviders = W(G({}, this.httpProviders), {
    ...
    async getCapabilities(e) {
        ...
        const p = this.client.session.get(e.topic), l = ((n = p?.sessionProperties) == null ? void 0 : n.capabilities) || {}, h = o.length > 0 ? o.join(",") : `0x${this.chainId.toString(16)}`, f = `${c}${h}`, u = l?.[f];
        if (u) return u;
        let q;
        try {
            q = jt(p, c, o);
        ...
        try {
            await this.client.session.update(e.topic, {
                sessionProperties: W(G({}, p.sessionProperties || {}), {
                    capabilities: W(G({}, l || {}), {
                        [f]: V
                    })
                })
    ...
    getBundlerUrl(e, s) {
        return `${ut}?projectId=${this.client.core.projectId}&chainId=${e}&bundler=${s}`;
    }
    async sendCalls(e) {
        var s, i, r;
        ...
        return !c || !p || !(l != null && l.length) || await zt({
            sendCalls: {
                request: n,
                result: a
            },
...
class Tt {
    ...
    createHttpProvider(e, s) {
        const i = s || fe(e, this.namespace, this.client.core.projectId);
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
...
class N {
    constructor(e){
        ...
        this.providerOpts = e, this.logger = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createLogger"])({
            ...
            name: (i = this.providerOpts.name) != null ? i : he
    ...
    async authenticate(e, s) {
        ...
        if (this.session = a.session, this.session) {
            const n = we(this.session.namespaces);
    ...
    createProviders() {
        ...
        B("client", this.client), B("events", this.events), B("disableProviderPing", this.disableProviderPing), e.forEach((s)=>{
            ...
            const r = me(i), a = C(this.namespaces, this.optionalNamespaces), n = j(S({}, a[s]), {
                accounts: i,
                chains: r
            });
            switch(s){
    ...
    registerEventListeners() {
        ...
        this.client.on("session_ping", (e)=>{
            ...
            if (a.name === "accountsChanged") {
                const n = a.data;
                n && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidArray"])(n) && this.events.emit("accountsChanged", n.map(ve));
            } else if (a.name === "chainChanged") {
                const n = i.chainId, c = i.event.data, o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(n), p = U(n) !== U(c) ? `${o}:${U(c)}` : n;
                this.onChainChanged({
    ...
    emitAccountsChangedOnChainChange({ namespace: e, currentCaipChainId: s, previousCaipChainId: i }) {
        ...
        try {
            ...
            if (!n) return;
            const c = n.filter((o)=>o.includes(`${s}:`)).map(ve);
...
//# sourceMappingURL=node_modules_%40walletconnect_c5254a70._.js.map