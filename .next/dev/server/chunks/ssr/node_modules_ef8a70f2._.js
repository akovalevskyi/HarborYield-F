            ...
            async connect ({ chainId, withCapabilities, ...rest } = {}) {
                try {
                    ...
                    let { accounts, currentChainId } = await (async ()=>{
                        ...
                        const accounts = orderedAccounts.map((account1)=>response.accounts.find((account2)=>account2.address === account1) ?? {
                                address: account1
                            });
                        return {
            ...
            async getProvider () {
                if (!walletProvider) {
                    ...
                    const { createBaseAccountSDK } = await (()=>{
                        ...
                        try {
                            return __turbopack_context__.A("[project]/node_modules/@base-org/account/dist/index.node.js [app-ssr] (ecmascript, async loader)");
                        } catch  {
            ...
            async getProvider () {
                if (!walletProvider) {
                    const { createCoinbaseWalletSDK } = await (()=>{
                        ...
                        try {
                            return (()=>{
                                const e = new Error("Cannot find module '@coinbase/wallet-sdk'");
            ...
            async getProvider () {
                if (!walletProvider) {
                    const { GeminiWalletProvider } = await (()=>{
                        ...
                        try {
                            return (()=>{
                                const e = new Error("Cannot find module '@gemini-wallet/core'");
                                e.code = 'MODULE_NOT_FOUND';
                                throw e;
                            })();
                        } catch  {
                ...
                async function initProvider() {
                    ...
                    const MetaMaskSDK = await (async ()=>{
                        const { default: SDK } = await (()=>{
                            ...
                            try {
                                return (()=>{
                                    const e = new Error("Cannot find module '@metamask/sdk'");
                                    e.code = 'MODULE_NOT_FOUND';
                                    throw e;
                                })();
                            } catch  {
                ...
                try {
                    if (!accounts?.length && !isReconnecting) {
                        const { RpcSchema } = await (()=>{
                            ...
                            try {
                                return (()=>{
                                    const e = new Error("Cannot find module 'porto'");
                                    e.code = 'MODULE_NOT_FOUND';
                                    throw e;
                                })();
                            } catch  {
                        ...
                        const { z } = await (()=>{
                            ...
                            try {
                                return (()=>{
                                    const e = new Error("Cannot find module 'porto/internal'");
                                    e.code = 'MODULE_NOT_FOUND';
                                    throw e;
                                })();
                            } catch  {
...
const version = '7.1.6'; //# sourceMappingURL=version.js.map
}),
            ...
            async getProvider ({ chainId } = {}) {
                async function initProvider() {
                    ...
                    const { EthereumProvider } = await (()=>{
                        ...
                        try {
                            return (()=>{
                                const e = new Error("Cannot find module '@walletconnect/ethereum-provider'");
                                e.code = 'MODULE_NOT_FOUND';
                                throw e;
                            })();
                        } catch  {
...
//# sourceMappingURL=node_modules_ef8a70f2._.js.map