...
function Banner() {
    ...
    const handleFaucet = async (targetChainId)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$core$2f$dist$2f$esm$2f$actions$2f$waitForTransactionReceipt$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["waitForTransactionReceipt"])(wagmiConfig, {
                hash
            });
        } catch (err) {
...
function Header() {
    ...
    const balanceDisplay = isConnected && balance ? formatBalance((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$unit$2f$formatUnits$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatUnits"])(balance, USDX_DECIMALS)) : "--";
...
function ShopPage() {
    ...
    const handleBuySuggested = async ()=>{
        ...
        try {
            ...
            const receipt = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$core$2f$dist$2f$esm$2f$actions$2f$waitForTransactionReceipt$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["waitForTransactionReceipt"])(wagmiConfig, {
                hash: payHash
            });
            let batchId = null;
            try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__088c5c43._.js.map