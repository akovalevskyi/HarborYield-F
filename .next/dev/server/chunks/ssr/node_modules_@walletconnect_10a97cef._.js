...
function $(t, e, s, i) {
    ...
    for(let a = 0; a < r.length; a++){
        ...
        if (ae(c) && (c = {
            ...
            ...o
        }), typeof Buffer < "u" && Buffer.isBuffer(c) && (c = re(c)), Array.isArray(c)) if (typeof o == "object" && o != null) {
...
async function Lt(t, e) {
    const s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseChainId"])(t.result.capabilities.caip345.caip2), i = t.result.capabilities.caip345.transactionHashes, r = await Promise.allSettled(i.map((h)=>Mt(s.reference, h, e))), a = r.filter((h)=>h.status === "fulfilled").map((h)=>h.value).filter((h)=>h);
...
async function zt({ sendCalls: t, storage: e }) {
    ...
    await e.setItem(v, Bt(Ut({}, s), {
        [t.result.id]: {
            request: t.request,
            result: t.result,
            expiry: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calcExpiry"])(dt)
        }
    }));
}
    ...
    registerEventListeners() {
        ...
        this.client.on("session_ping", (e)=>{
            ...
            if (a.name === "accountsChanged") {
                const n = a.data;
                n && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidArray"])(n) && this.events.emit("accountsChanged", n.map(ve));
            } else if (a.name === "chainChanged") {
                const n = i.chainId, c = i.event.data, o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(n), p = U(n) !== U(c) ? `${o}:${U(c)}` : n;
                this.onChainChanged({
...
//# sourceMappingURL=node_modules_%40walletconnect_10a97cef._.js.map