...
"[project]/src/app/asset/[chainId]/[tokenId]/page.client.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AssetPage() {
    ...
    const assets = Array.isArray(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$assets$2e$json__$28$json$29$__["default"]?.assets) ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$assets$2e$json__$28$json$29$__["default"].assets : [];
    const asset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>assets.find((item)=>Number(item.chainId) === chainId && Number(item.tokenId) === tokenId), [
        assets,
        chainId,
        tokenId
    ]);
    ...
    const chainMeta = CHAIN_META[chainId] || {
        name: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$assets$2e$json__$28$json$29$__["default"]?.networks?.[String(chainId)]?.name ?? `Chain ${chainId || "?"}`,
        icon: "/eth.svg"
    };
    const image = typeof asset?.image === "string" && asset.image.trim().length > 0 ? asset.image : "linear-gradient(135deg, #cfd6df, #f4f1ed)";
    const imageStyle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    const issuerRate = typeof issuerRateRaw === "number" ? `${issuerRateRaw}/100` : issuerRateRaw ?? "—";
    const fallbackMaxSupply = toNumber(asset?.supplyForDemo ?? asset?.maxSupply ?? asset?.available ?? asset?.issued ?? asset?.supply) ?? null;
    const aprValue = asset?.apr;
    const aprLabel = aprValue === true ? "APR" : typeof aprValue === "number" ? `${aprValue}%` : typeof aprValue === "string" ? aprValue : null;
    const supplyQueries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    const { data: supplyData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$wagmi$2f$dist$2f$esm$2f$hooks$2f$useReadContracts$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useReadContracts"])({
    ...
    const mintedOnChain = typeof supplyData?.[0]?.result === "bigint" ? Number(supplyData[0].result) : null;
    const maxOnChain = typeof supplyData?.[1]?.result === "bigint" ? Number(supplyData[1].result) : null;
    const issuedValue = maxOnChain ?? fallbackMaxSupply;
    const availableValue = issuedValue != null ? Math.max(issuedValue - (mintedOnChain ?? 0), 0) : null;
    ...
    const totalBase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const safeQty = Number.isFinite(qty) && qty > 0 ? qty : 0;
        if (!unitPrice || safeQty <= 0) return 0n;
        try {
            const unit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$unit$2f$parseUnits$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseUnits"])(String(unitPrice), usdxDecimals);
    ...
    const handleBuy = async ()=>{
        ...
        if (usdxBalanceBase && totalBase > usdxBalanceBase) {
            const balance = Number((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$unit$2f$formatUnits$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatUnits"])(usdxBalanceBase, usdxDecimals));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Shell$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$BlockingModal$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                ...
                fileName: "[project]/src/app/asset/[chainId]/[tokenId]/page.client.js",
                lineNumber: 404,
                columnNumber: 7
            }, this),
            ...
            !asset ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "We couldn't find this asset in the current dataset."
                            }, void 0, false, {
                                fileName: "[project]/src/app/asset/[chainId]/[tokenId]/page.client.js",
                                lineNumber: 423,
                                columnNumber: 13
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "asset-media",
                        style: imageStyle,
                        children: aprLabel ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "asset-sub",
                                children: asset.subname ?? asset.issuer ?? "—"
                            }, void 0, false, {
                                fileName: "[project]/src/app/asset/[chainId]/[tokenId]/page.client.js",
                                lineNumber: 436,
                                columnNumber: 13
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                children: availableValue != null ? formatNumber(availableValue) : "—"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/asset/[chainId]/[tokenId]/page.client.js",
                                                lineNumber: 451,
                                                columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                children: issuedValue != null ? formatNumber(issuedValue) : "—"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/asset/[chainId]/[tokenId]/page.client.js",
                                                lineNumber: 455,
                                                columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: unitPrice > 0 ? `${formatNumber(unitPrice)} USDx` : "—"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/asset/[chainId]/[tokenId]/page.client.js",
                                        lineNumber: 459,
                                        columnNumber: 15
...
//# sourceMappingURL=%5Broot-of-the-server%5D__66fea4e2._.js.map